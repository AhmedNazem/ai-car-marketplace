  ...
  return (
    <div className="pt-20 flex-col">
      ...
      <section className="py-16">
        <div className="container mk-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              <div className="bg-blue-100 text-blue-700 rounded-full size-16  flex items-center justify-center mx-auto mb-4">
      ...
      {/* seducing to join the  marketplace  */}
